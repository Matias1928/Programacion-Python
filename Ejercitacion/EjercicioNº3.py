''''Realizar el juego PIEDRA, PAPEL O TIJERA. El usuario deberá competir contra la PC. El triunfador será quien gane 3 partidas.'''
...
if elijePc == "papel" and elijeUsuario == "piedra":
    ...
    #Aclaracion use un poco de ayuda de internet... 